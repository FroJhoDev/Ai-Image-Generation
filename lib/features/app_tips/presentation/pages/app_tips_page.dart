...
class AppTipsPage extends StatefulWidget {
  const AppTipsPage({super.key});

  @override
  State<AppTipsPage> createState() => _AppTipsPageState();
}

class _AppTipsPageState extends State<AppTipsPage> {
  @override
