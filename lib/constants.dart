class ApiConstants {
  static String baseUrl = 'https://api.openai.com/v1/images';
  static String generationsEndpoint = '/generations';
  static String secretKey = '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';
}

class RandomPrompts {
  static List<String> promptsList = [
    'a white siamese cat',
